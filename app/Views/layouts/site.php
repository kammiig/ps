...
<head>
    ...
    <link rel="preload" href="<?= e(asset('css/style.css')) ?>?v=20260602-hosting-dns" as="style">
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260602-hosting-dns">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260602-hosting-dns" defer></script>
