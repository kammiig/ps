...
<head>
    ...
    <link rel="preload" href="<?= e(asset('css/style.css')) ?>?v=20260518-whmcs-api" as="style">
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260518-whmcs-api">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260518-whmcs-api" defer></script>
