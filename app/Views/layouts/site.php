...
<head>
    ...
    <link rel="preload" href="<?= e(asset('css/style.css')) ?>?v=20260601-payment-status" as="style">
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260601-payment-status">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260601-payment-status" defer></script>
