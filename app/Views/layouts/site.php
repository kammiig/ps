...
<head>
    ...
    <link rel="preload" href="<?= e(asset('css/style.css')) ?>?v=20260522-stripe-account" as="style">
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260522-stripe-account">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260522-stripe-account" defer></script>
