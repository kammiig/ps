...
<head>
    ...
    <link rel="preload" href="<?= e(asset('css/style.css')) ?>?v=20260518-billing-cycle" as="style">
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260518-billing-cycle">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260518-billing-cycle" defer></script>
