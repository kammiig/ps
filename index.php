...
$router->get('/account/domains/{domain}/dns', [AccountController::class, 'domainDns']);
$router->post('/account/domains/{domain}/dns/records', [AccountController::class, 'saveDnsRecord']);
$router->post('/account/domains/{domain}/dns/records/{recordId}/delete', [AccountController::class, 'deleteDnsRecord']);
$router->post('/account/domains/{domain}/dns/nameservers', [AccountController::class, 'updateDomainNameservers']);
$router->get('/account/dns/{domainId}', [AccountController::class, 'manageDns']);
$router->post('/account/dns/{domainId}', [AccountController::class, 'manageDns']);
$router->get('/account/tickets', [AccountController::class, 'tickets']);
$router->get('/account/tickets/new', [AccountController::class, 'newTicket']);
$router->post('/account/tickets/new', [AccountController::class, 'newTicket']);
$router->get('/account/tickets/{id}', [AccountController::class, 'ticketDetail']);
$router->post('/account/tickets/{id}/reply', [AccountController::class, 'replyTicket']);
